# Athira Lekshmi Mohandas Sandhya — Academic Website

This repository is a customized al-folio academic website for **Athira Lekshmi Mohandas Sandhya**.

Main content files:
- `_pages/about.md` — homepage
- `_pages/projects.md` and `_projects/` — research
- `_bibliography/papers.bib` — publications
- `_data/cv.yml` — CV content
- `_data/socials.yml` — academic/social links
- `assets/img/prof_pic.jpg` — profile image

Site URL: https://athiralekshmims.github.io
